...
public class BindChargeBank implements Serializable {
	...
	public BindChargeBank() {
	}

	public BindChargeBank(Long id, String userCode, String province, String city, String subBank, String bankName, String bankCode, Integer easyFlag, Date createTime, Date updateTime) {
		this.id = id;
