package com.cm.account.http.alipay.util;
...
import com.cm.account.http.alipay.config.AlipayConfig;
import com.cm.account.http.alipay.sign.MD5;
import com.cm.account.http.alipay.util.httpClient.HttpProtocolHandler;
import com.cm.account.http.alipay.util.httpClient.HttpRequest;
import com.cm.account.http.alipay.util.httpClient.HttpResponse;
import com.cm.account.http.alipay.util.httpClient.HttpResultType;
